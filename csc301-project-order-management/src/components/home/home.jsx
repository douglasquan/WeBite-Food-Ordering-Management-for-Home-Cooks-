        ...
        <div>
            ...
            <div className="relative text-white text-center py-36 px-12">
              <div className="absolute inset-0 bg-cover bg-center opacity-25"
                   style={{backgroundImage: `url(${backgroundImage})`, backdropFilter: 'blur(0px)'}}></div>
          ...
          <div className="flex-grow flex flex-wrap md:flex-nowrap justify-center md:justify-between items-start p-4">
            ...
            <div className="w-full md:w-1/2 p-4">
              <div className="bg-gray-400 text-white m-2 rounded-lg p-4">
                ...
                <div className="grid grid-cols-4 gap-4">
                  <Link to="/customer" className="bg-white rounded shadow p-4 block text-center" href="Customer">Customer
                    1</Link>
                  <Link to="/customer" className="bg-white rounded shadow p-4 block text-center" href="Customer">Customer
                    2</Link>
                  <Link to="/customer" className="bg-white rounded shadow p-4 block text-center" href="Customer">Customer
